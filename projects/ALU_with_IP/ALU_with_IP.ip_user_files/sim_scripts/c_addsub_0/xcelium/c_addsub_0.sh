...
#
# Script generated by Vivado on Sat May 18 16:10:36 +0530 2024
...
#
# Usage        : c_addsub_0.sh
#                c_addsub_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                c_addsub_0.sh [-reset_run]
#                c_addsub_0.sh [-reset_log]
#                c_addsub_0.sh [-help]
#
...
#                script (type 'c_addsub_0.sh -help' for more information).
#
...
# script info
echo -e "c_addsub_0.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./c_addsub_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.c_addsub_0
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.c_addsub_0 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log c_addsub_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: c_addsub_0.sh [-step]\n\
Usage: c_addsub_0.sh [-lib_map_path]\n\
Usage: c_addsub_0.sh [-reset_run]\n\
Usage: c_addsub_0.sh [-reset_log]\n\
Usage: c_addsub_0.sh [-keep_index]\n\
