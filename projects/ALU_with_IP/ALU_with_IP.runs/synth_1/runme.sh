...
HD_PWD='D:/DVCON/RTL_Vivado/projects/ALU_with_IP/ALU_with_IP.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log alu_ip.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source alu_ip.tcl
