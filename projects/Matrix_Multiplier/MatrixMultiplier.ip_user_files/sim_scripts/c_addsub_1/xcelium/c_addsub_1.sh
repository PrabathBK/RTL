...
#
# Script generated by Vivado on Sat May 18 22:44:15 +0530 2024
...
#
# Usage        : c_addsub_1.sh
#                c_addsub_1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                c_addsub_1.sh [-reset_run]
#                c_addsub_1.sh [-reset_log]
#                c_addsub_1.sh [-help]
#
...
#                script (type 'c_addsub_1.sh -help' for more information).
#
...
design_libs_elab="-libname xbip_utils_v3_0_11 -libname c_reg_fd_v12_0_7 -libname xbip_dsp48_wrapper_v3_0_5 -libname xbip_pipe_v3_0_7 -libname xbip_dsp48_addsub_v3_0_7 -libname xbip_addsub_v3_0_7 -libname c_addsub_v12_0_16 -libname xil_defaultlib -libname secureip"

# set design libraries
design_libs=(simprims_ver xbip_utils_v3_0_11 c_reg_fd_v12_0_7 xbip_dsp48_wrapper_v3_0_5 xbip_pipe_v3_0_7 xbip_dsp48_addsub_v3_0_7 xbip_addsub_v3_0_7 c_addsub_v12_0_16 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "c_addsub_1.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./c_addsub_1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.c_addsub_1
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.c_addsub_1 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log c_addsub_1_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: c_addsub_1.sh [-step]\n\
Usage: c_addsub_1.sh [-lib_map_path]\n\
Usage: c_addsub_1.sh [-reset_run]\n\
Usage: c_addsub_1.sh [-reset_log]\n\
Usage: c_addsub_1.sh [-keep_index]\n\
